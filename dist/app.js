...
const authRouter_1 = require("./routse/authRouter");
const commentsRouter_1 = require("./routse/commentsRouter");
...
exports.app.use('/comments', commentsRouter_1.commentsRouter);
exports.app.delete('/testing/all-data', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield db_1.client.db('hometask3').collection('Comments').deleteMany({});
